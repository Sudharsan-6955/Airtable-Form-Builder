      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              To exercise these rights, please contact us at <a href="mailto:support@airtableformbuilder.com" className="text-blue-600 hover:underline">support@airtableformbuilder.com</a>
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              <p className="text-gray-700">
                <strong>Email:</strong> <a href="mailto:support@airtableformbuilder.com" className="text-blue-600 hover:underline">support@airtableformbuilder.com</a>
              </p>
